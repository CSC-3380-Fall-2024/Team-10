...
var volume_percentage_effects = string(round(global.effects_volume *100));
draw_text(x + sprite_width/2 + 135, y - sprite_height/2 - 8, volume_percentage_effects);

//draw music so user knows what they are changing
draw_set_font(fnt_menu);
draw_set_halign(fa_center);
draw_set_color(c_white);
draw_text(x + 130, y - 60, "Effects");
