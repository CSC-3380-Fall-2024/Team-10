...
//add wheels - just two wheels for the motorbike

front_tyre = car_add_wheel(0,-8,true,true,obj_wheel); //top left 

back_tyre = car_add_wheel(0,10,false,true,obj_wheel); //bottom left 
