function rallycar_init() {
	...
	drift = 0.2//was 1; //drift control, usually between (0-1) but can be higher  //This value for the car (but not the wheel) has been disabled in the code because it causes the cars in collisions to have hardly any weight
	                        //0: no control | 1: high control
	drift_default = 0.5//was 1 //same number as above.  See step 2 of obj_car which returns the drift back to this default number after drifting                        
	drift_factor = 0.2//was 0.05 //see step 2 of obj_car, where this drift factor increases when holding left or right



	max_speed = 8  //was 6.7  //MAX SPEED maximum speed car can attain 
	...
	engine_acc = 9; //was 5.5 //ACCELERATION forward force, moving forward
	...
	torque_acc = 2;  //lower value is slower turning, higher value is faster turning      //extra torque on the car when turning 
