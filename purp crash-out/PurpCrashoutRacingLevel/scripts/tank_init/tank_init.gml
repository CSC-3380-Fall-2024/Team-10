function tank_init() {
	...
	drift_activated = 0 //See step 2 of obj_car, which activates drifting when holding left or right on the controller                        
	...
	drift_factor = 0 //see step 2 of obj_car, where this drift factor increases when holding left or right

	max_speed = 11  //MAX SPEED maximum speed car can attain 
	...
	wheel_angle_velocity=16; //STEERING how quickly a wheel rotates.  0 is hardly rotates
	...
	torque_acc = 16;  //lower value is slower turning, higher value is faster turning      //extra torque on the car when turning 
