function sportscar_init() {
	...
	drift_factor = 0.05 //see step 2 of obj_car, where this drift factor increases when holding left or right



	max_speed = 8.5  //MAX SPEED maximum speed car can attain 
