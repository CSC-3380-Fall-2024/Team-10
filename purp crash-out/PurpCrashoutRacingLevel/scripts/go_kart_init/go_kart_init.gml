function go_kart_init() {
	...
	drift_factor = 0.15 //see step 2 of obj_car, where this drift factor increases when holding left or right


	max_speed = 9.2  //MAX SPEED maximum speed car can attain 
	...
	engine_acc = 11; //ACCELERATION forward force, moving forward
